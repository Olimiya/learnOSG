...
//        Viewpoint( "Africa",            0.0,   0.0, 0.0, 10.0, -90.0, 10e6 ),
//        Viewpoint( "Africa",            0.0,   0.0, 0.0, 50.0, -90.0, 10e6 ),
//        //          name                long   lat   z  heading pitch range
//        Viewpoint( "Africa",            0.0,   0.0, 0.0, 100.0, -90.0, 10e6 ),
//        Viewpoint( "Africa",            0.0,   0.0, 0.0, 0.0, -90.0, 10e6 ),
//        Viewpoint( "Africa",            0.0,   0.0, 0.0, 0.0, -90.0, 10e6 )
...
//            {
//                fly(_manip.get(), 0, 0, 20, 20);

////                auto a = ea.getKey()-'1';
////                _manip->setViewpoint( VPs[ea.getKey()-'1'], 1.0 );
////                aa.requestRedraw();
//            }
//            return false;
//        }
