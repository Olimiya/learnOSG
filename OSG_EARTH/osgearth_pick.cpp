...
//        if (feature) {
//            _app.fidLabel->setText(Stringify() << "Feature ID = " << feature->getFID()
//                                               << " (oid = " << id << ")");
...
//                             \n" "flat out int selected; \n" "void checkForHighlight(inout vec4
//                             vertex) \n"
//                             "{ \n"
//                             "    selected = (objectid_to_highlight > 1u && objectid_to_highlight
//                             "
//                             "== oe_index_objectid) ? 1 : 0; \n"
//                             "} \n";
...
//                             "clamp(vec3(0.5,2.0,2.0)*(1.0-color.rgb), 0.0, 1.0), 0.5); \n"
//                             "} \n";
...
//     view->getCamera()->setViewMatrixAsLookAt(osg::Vec3d(0, -1, 0), osg::Vec3d(0, 0, 0),
//                                              osg::Vec3d(0, 0, 1));
...
//                     "void swap(inout vec4 c) { c.rgba = c==vec4(0)? vec4(1) : "
//                     "vec4(vec3((c.r+c.g+c.b+c.a)/4.0),1); }\n";
//    osgEarth::Registry::shaderGenerator().run(geode);
//    VirtualProgram::getOrCreate(geode->getOrCreateStateSet())
//        ->setFunction("swap", fs, ShaderComp::LOCATION_FRAGMENT_COLORING);
...
//        app.rttView->getCamera()->setGraphicsContext(
//            app.mainView->getCamera()->getGraphicsContext());
