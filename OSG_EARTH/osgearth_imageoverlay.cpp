...
//    // the outer container:
//    s_layerBox = new Grid();
//    s_layerBox->setBackColor(0, 0, 0, 0.0);
...
//     OE_NOTICE << "   --image <file> xmin ymin xmax ymax : An image to overlay and it's bounds"
//               << std::endl;
//     OE_NOTICE << "   --vert                             : Move individual verts when editing"
//               << std::endl;
...
//     {
//     }
//     void onValueChanged(Control *control, float value) { _overlay->setAlpha(value); }
...
//     {
//     }
//     void onValueChanged(Control *control, bool value) { _overlay->setNodeMask(value ? ~0 : 0); }
//     ImageOverlay *_overlay;
// };
...
//{
//     UpdateLabelCallback(LabelControl *label, ImageOverlay *overlay,
...
//    std::string filename;
//    Bounds bounds;
//    while (arguments.read("--image", filename, bounds.xMin(), bounds.yMin(), bounds.xMax(),
//                          bounds.yMax())) {
...
//    if (imageFiles.empty()) {
//        imageFiles.push_back("model/test.svg");
...
//            osg::Vec4 color(0.4, 0.5, 1.0, 1.0);
...
//            // ImageOverlay* overlay = new
//            // ImageOverlay(mapNode->getMap()->getProfile()->getSRS()->getEllipsoid(), image);
